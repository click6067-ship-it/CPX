# 다음 세션 인계 — 설사·변비 발현소견 검토표 (2026-08-12 **14라운드** 종료 시점)

> 이 파일부터 읽고 시작한다. 이전 세션 전문은 `~/main/logs/`, 요약은 `docs/worklog.md` 맨 끝,
> 검수 이력 정본은 `docs/verification-log.yaml`(**14라운드까지** 기록됨).
...
- 설사 20카드 소견71·조건23·참고91 / 변비 15카드 소견53·조건15·참고51 = **304건, 인용 대조 304/304 통과 · 구조 경고 0건**
...
**MAJOR·MINOR는 14라운드에서 전량 반영했다. 11차 검수 결과가 다음 시작점이다.**
남은 설계 과제: Rome IV 원문 확보(Bristol 아형·IBS 배제 조건) · 장티푸스 별도 카드.
